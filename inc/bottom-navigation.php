<!-- mobile bottom navbar -->
									<nav class="md:hidden fixed bottom-0 left-0 right-0 nuenti-blue shadow-lg z-30">
										<div class="flex items-center">
											<a class="mobile-nav-item " href="inicio.php">
											...
											<a class="mobile-nav-item " href="mensajes.php">
											...
											<a class="mobile-nav-item " href="gente.php">
